...
public final class ZugferdBasicwlXsdValidator implements XsdValidator {

    private static final String SCHEMA_LOCATION = "/xsd/basicwl/Factur-X_1.09_BASICWL.xsd";

    private final Schema schema;

    public ZugferdBasicwlXsdValidator() {
        try {
            ...
            throw new IllegalStateException("Unable to load ZUGFeRD BASICWL XML schema.", e);
        }
    }
    ...
    public void validate(File file) {
        ...
        try {
            ...
            throw new XsdValidationException("XML document is not valid according to the ZUGFeRD BASICWL schema.", e);
