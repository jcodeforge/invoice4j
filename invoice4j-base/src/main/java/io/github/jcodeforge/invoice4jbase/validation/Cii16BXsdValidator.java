...
public final class Cii16BXsdValidator implements XsdValidator {

    private static final String SCHEMA_LOCATION = "/xsd/cii/16b/CrossIndustryInvoice_100pD16B.xsd";

    private final Schema schema;

    public Cii16BXsdValidator() {
        try {
            ...
            throw new IllegalStateException("Unable to load CII 16B XML schema.", e);
        }
    }
    ...
    public void validate(File file) {
        ...
        try {
            ...
            throw new XsdValidationException("XML document is not valid according to the CII 16B schema.", e);
